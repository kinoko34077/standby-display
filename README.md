...
📱 iPhone/iPad のホーム画面から常時表示可能な、**和暦･正刻･時辰･六曜･天気付きのクソデカ時計**です。
...
- **クソデカ時計**モード
- 縦画面・横画面でレイアウト自動切替
- 天気APIから実データ取得(位置情報から15分間隔で取得します)
...
25/05/05
- 曜日表示変更(括弧無し､色変え表示へ)
- 月齢･六曜対応｡(位置情報取得により自動で月齢計算)
- 天気対応(こちらも位置情報から自動取得｡天候の絵文字表記と温度のみ)
